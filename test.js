...
const desiredNetwork = '65535' // '1' is the Ethereum main network ID.
...
if (typeof window.ethereum === 'undefined') {
  ...
  .then(function (accounts) {
    ...
    if (ethereum.networkVersion !== desiredNetwork) {
      alert('This application requires the rePurpose network, please switch it in your MetaMask UI.')
